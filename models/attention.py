...
class SinkhornDistanceFast(nn.Module):
    def __init__(self, eps=1, max_iter=5):
        """
...
class WeightedCombinationAttention(nn.Module):
    def __init__(self,
        ...
        self.sinkhorn_attn = SinkhornAttention(dim,
                                               num_heads,
                                               qkv_bias,
                                               proj_bias,
                                               attn_drop,
...
class WeightedCombinationLearnableAttention(nn.Module):
    def __init__(self,
                 dim,
                 num_heads=8,
                 qkv_bias: bool = False,
        ...
        # Call the superclass constructor
        super(WeightedCombinationLearnableAttention, self).__init__()
